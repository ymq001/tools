...
var MoveLine = function MoveLine(map, userOptions) {
    ...
    function Marker(opts) {
        ...
        this.fontSize = opts.fontSize || "12px";
        this.fontFamily = opts.fontFamily || "Microsoft YaHei";
    ...
    Marker.prototype.draw = function (context) {
        ...
        var measureWidth = context.measureText(this.city).width;
        var _offsetX = this.offsetX >= 0 ? this.offsetX + measureWidth / 2 : this.offsetX - measureWidth / 2;
        ...
        context.font = this.fontSize.concat(" ").concat(this.fontFamily);
        context.fillStyle = this.color;
        context.fillText(this.city, pixel.x + _offsetX, pixel.y + _offsetY);
        context.restore();
    };
...
MoveLine.prototype.update = function (resetOpts, callback) {
