...
(function () {
    ...
    */
    ...
    //var _IMAGE_PATH = 'http://' + location.hostname + location.port + '/images/m';
    ...
    */
        BMapLib.TextIconOverlay = function (position, text, options) {
            ...
            _IMAGE_PATH = this._options["image_path"] || _IMAGE_PATH;
    ...
    */
    TextIconOverlay.prototype._updateText = function () {
        if (this._domElement) {
            this._domElement.innerHTML = '<p style="line-height: 27px;font-size: 10px;width: 70px;">展厅：' + this._text + '</p>';
        }
    };
